...
//
typedef WORD COLOR_TYPE;	// A 16 bit 555 type color.
...
#define DOOR_OPENED			0x0001	// set is open
#define DOOR_RIGHTLEFT		0x0002
#define DOOR_INOUT			0x0004
#define DOOR_NORTHSOUTH		0x0008
#define DOOR_OFFSET_MAX		0x000f
...
enum ANIM_TYPE	// not all creatures animate the same for some reason.
{
...
#if 0
	// # mounted animations - 43-99
	43	Llama_Walk_01
	44	Llama_Run_01
	45	Llama_Idle_01
	46	Llama_Attack1H_SlashRight_01
	47	Llama_AttackBow_01
	48	Llama_AttackCrossbow_01
	49	Llama_Attack2H_SlashRight_01

	53	Ostard_Walk_01
	54	Ostard_Run_01
	55	Ostard_Idle_01
	56	Ostard_Attack1H_SlashRight_01
	57	Ostard_AttackBow_01
	58	Ostard_AttackCrossbow_01
	59	Ostard_Attack2H_SlashRight_01

	63    Kirin_Walk_01
	64    Kirin_Run_01
	65    Kirin_Idle_01
	66    Kirin_Attack1H_SlashRight_01
	67    Kirin_AttackBow_01
	68    Kirin_AttackCrossbow_01
	69    Kirin_Attack2H_SlashRight_01

	73    Seahorse_Walk_01
	74    Seahorse_Run_01
	75    Seahorse_Idle_01
	76    Seahorse_Attack1H_SlashRight_01
	77    Seahorse_AttackBow_01
	78    Seahorse_AttackCrossbow_01
	79    Seahorse_Attack2H_SlashRight_01

	// # social animations - 100-199
	...
	115	lecture_01
	116	nod_yes_01
	117	point_assertive_01
	118	salute_armed1h_01
	119	salute_greeting_01
	120	salute_unarmed_01
	121	shake_no_01
	122	up_yours!_01
	123	victory_01
	124	victory_02
	125	wave_1h_01
	126	wave_2h_01
	127	wave_long_distance_01
	128	what!_01

	// # spell casting animations - 200-299 - spaces are for future spell variations

	200	spell_dir_1h_l1_01
	201	spell_dir_1h_l1_02
	203	spell_dir_1h_l2_01
	204	spell_dir_1h_l2_02
	205	spell_dir_1h_l2_03
	206	spell_dir_1h_l3_01
	207	spell_dir_1h_l3_02
	209	spell_dir_1h_l4_01
	210	spell_dir_1h_l4_02
	212	spell_dir_2h_l1_01
	215	spell_dir_2h_l2_01
	218	spell_dir_2h_l3_01
	221	spell_dir_2h_l4_01
	224	spell_earth_2h_l1_01
	227	spell_earth_2h_l2_01
	230	spell_earth_2h_l3_01
	233	spell_earth_2h_l4_01
	236	spell_sky_2h_l1_01
	239	spell_sky_2h_l2_01
	242	spell_sky_2h_l3_01
	245	spell_sky_2h_l4_01
	248	spell_staff_2h_l1_01
	251	spell_staff_2h_l2_01
	254	spell_staff_2h_l3_01
	257	spell_staff_2h_l4_01
	260	spell_summon_2h_l1_01
	263	spell_summon_2h_l2_01
	266	spell_summon_2h_l3_01
	267	spell_summon_2h_l3_02
	269	spell_summon_2h_l4_01
...
enum LAYER_TYPE		// defined by UO. Only one item can be in a slot.
{
	...
	LAYER_HIDDEN,	// 15 = unknown ? Might have been another pack ?
...
enum GUMP_TYPE	// The gumps. (most of these are not useful to the server.)
{
	...
	GUMP_CORPSE = 0x09,
	GUMP_SPHERE_MAN = 0x0c,
	GUMP_SPHERE_WOMAN = 0x0d,
...
enum
{
	...
	TERRAIN_QTY     = 0x4000,	// Terrain tile qty = offset of the start of items in ART.MUL

	// Above this is item tile indexes.
};

/////////////////////////////////////////////////////////////////
// File blocks

#define VERDATA_MAKE_HASH( f, i )	((f)<< 26 | (i))	// HASH_INDEX
#define VERDATA_GET_FILE(i)			((VERFILE_TYPE)((i)>>26))
#define VERDATA_GET_INDEX(i)		((i)&(_1BITMASK(26)-1))

enum VERFILE_TYPE		// skew list. (verdata.mul)
{
	VERFILE_MAP0		= 0x00,	// "map0.mul" = Array of base Terrain data
	VERFILE_STAIDX0		= 0x01,	// "staidx0.mul" = Index into STATICS0
	VERFILE_STATICS0	= 0x02,	// "statics0.mul" = Static objects on the map
	...
	VERFILE_MULTIIDX	= 0x0D,	// "multi.idx" = Index to MULTI
	...
	VERFILE_RADARCOL	, // ? "radarcol.mul" (not sure). = COLOR_TYPE for converting the terrain data to radar view
	...
	VERFILE_LIGHTIDX	, // ? "lightidx.mul" = index into light pattern bitmaps.
	VERFILE_SPEECH		, // ? "speech.mul"	= replace a bunch of speech client side. > 2.0.5 new versions only.
	VERFILE_VERDATA		, // ? "verdata.mul" = This version file.

	VERFILE_MAP2		,	// "map0.mul" = Array of base Terrain data
	VERFILE_STAIDX2		,	// "staidx0.mul" = Index into STATICS0
	VERFILE_STATICS2	,	// "statics0.mul" = Static objects on the map

	VERFILE_UNK_1B,
	VERFILE_UNK_1C,
	VERFILE_UNK_1D,
	// 	VERFILE_ANIMINFO	, // ? "animinfo.mul" = ? no idea. probably nothing.
	//  VERFILE_CHARDATA	, // ? "chardata.mul" = ? no idea. probably nothing.
	...
	VERFILEX_HUES		= 0x20, // ? "hues.mul"
	// NOTE: 021 is used for something ?!

	VERFILEX_MAPDIFL0,		// "mapdifl0.mul" = // The point location for the change block.
	VERFILEX_MAPDIF0,		// "mapdif0.mul" = the terrain data.
	VERFILEX_STADIFL0,		// "stadifl0.mul" = // The point location for the change block.
	VERFILEX_STADIFI0,		// "stadifi0.mul" = the index blocks for "stadif0.mul"
	VERFILEX_STADIF0,		// "stadif0.mul"

	VERFILEX_MAPDIFL1,		// The point location for the change block.
	VERFILEX_MAPDIF1,
	VERFILEX_STADIFL1,		// The point location for the change block.
	VERFILEX_STADIFI1,
	VERFILEX_STADIF1,
...
struct CMulVersionBlock	// skew list. (verdata.mul)
{
	// First 4 bytes of this file = the qty of records.
private:
	DWORD m_file;		// file type id. VERFILE_TYPE (ex.tiledata = 0x1E)
	DWORD m_block;		// tile number. ( items = itemid + 0x200 ), tiledata is weird.
public:
	// This part is just like CMulIndexRec
	DWORD m_dwOffset;	// pos in this file to find the patch block.
	DWORD m_dwLength;

	WORD  m_wVal3;		// stuff that would have been in CMulIndexRec
	WORD  m_wVal4;
public:
	HASH_INDEX GetHashCode() const	// a single sortable index.
	{
		return( VERDATA_MAKE_HASH( m_file, m_block ));
	}
...
struct CMulIndexRec	// 12 byte block = used for table indexes. (staidx0.mul,multi.idx,anim.idx)
{
	// This defines WHERE data is Not WHAT it is.
private:
	DWORD	m_dwOffset;	// 0xFFFFFFFF = nothing here ! else pointer to something (CMulStaticItemRec possibly)
...
public:
	...
	{
		// Offset into the verdata or base file for this type.
		return( m_dwOffset );
	}
	...
	{
		// This is really an offset into the VerData file.
	...
	void CopyIndex( const CMulVersionBlock * pVerData )
	{
		// Get an index rec from the verdata rec.
		m_dwOffset = pVerData->m_dwOffset;
		m_dwLength = pVerData->m_dwLength | 0x80000000;
...
#define SPHEREMAP_BLOCK_ALIGN(i) 	((i) &~ 7 )
#define SPHEREMAP_BLOCK_OFFSET(i)	((i) & 7 )	// i%SPHEREMAP_BLOCK_SIZE
#define SPHEREMAP_BLOCK_ROUND(i)	SPHEREMAP_BLOCK_ALIGN((i)+7)
#define SPHEREMAP_SIZE_Z			127
...
// Map 0
#define UO_SIZE0_X			0x1800	// 768*SPHEREMAP_BLOCK_SIZE = 6144 = Total Size In meters
#define UO_SIZE0_Y			0x1000  // 512*SPHEREMAP_BLOCK_SIZE = 4096 = Total height
#define UO_SIZE0_X_REAL		0x1400	// 640*SPHEREMAP_BLOCK_SIZE = 5120 = The actual world is only this big
#define UO_SEX_CENTER_X 	1323	// Center of the sextant world (LB's throne)
#define UO_SEX_CENTER_Y		1624
// Map 2
#define UO_SIZE2_X			(288*SPHEREMAP_BLOCK_SIZE)	
#define UO_SIZE2_Y			(200*SPHEREMAP_BLOCK_SIZE)	
...
struct CMulMapMeter	// 3 bytes (map0.mul)
{
	...
	bool IsTerrainDirt() const;	// furrows

} PACK_NEEDED;

struct CMulTerrainBlock	// 196 byte block = 8x8 meters, (map0.mul, mapdif0.mul)
{
	DWORD m_dwID;	// ? header of some sort. (checksum?)
	CMulMapMeter m_Meter[ SPHEREMAP_BLOCK_SIZE * SPHEREMAP_BLOCK_SIZE ]; // 192 bytes
} PACK_NEEDED;

struct CMulStaticItemRec	// 7 byte block = static items on the map (statics0.mul)
{
	WORD	m_wTileID;		// ITEMID_TYPE = Index to tile CUOItemTypeRec
	BYTE	m_x;		// x <= 7 = offset from block.
	BYTE 	m_y;		// y <= 7
	signed char	m_z;		// PNT_Z_TYPE
	WORD 	m_wHue;		// HUE_TYPE modifier for the item

	// For internal caching purposes only. overload this.
	// LOBYTE(m_wColor) = Blocking flags for this item. (CAN_I_BLOCK etc)
...
struct CMulTerrainInfo:public CUOTerrainTypeRec
{
	CMulTerrainInfo( TERRAIN_TYPE id );
};
...
#define UFLAG3_CLOTH		0x00040000	// 12= Hueable. effects the way the client colors the item. color sphere scale stuff else must be converted to spherescale
...
#define UFLAG4_WALKABLE		0x80000000	// 1f= We can walk here.
	...
	static DIR_TYPE GetClimbableDir( DWORD flags );

} PACK_NEEDED;

inline DIR_TYPE CUOItemTypeRec::GetClimbableDir( DWORD flags )
{
	// ASSUME:UFLAG2_CLIMBABLE
	// DIR_N = 0
	// DIR_E = UFLAG4_STAIRS
	// DIR_W = UFLAG4_WALKABLE
	// DIR_S = UFLAG4_WALKABLE|UFLAG4_STAIRS
	switch ( flags >> 30 )
	{
	default:
	case 0: return DIR_N;
...
struct CMulItemInfo : public CUOItemTypeRec
{
	CMulItemInfo( ITEMID_TYPE id );
};
...
struct CMulMultiItemRec // (Multi.mul)
{
	...
	short m_dy;
	short m_dz;
	DWORD m_visible;	// 0 or 1 (non-visible items are things like doors and signs that can be dynamic)
...
#define UOHUE_BLOCK_QTY 8  // Come in blocks of 8
...
struct CUOHueEntryBare	// HUE.MUL
{
	// This is a single hue entry.
	COLOR_TYPE m_GammaRange[LIGHT_QTY];	// Range this hue from light=0 to Dark=31
} PACK_NEEDED;

struct CUOHueEntry	// HUE.MUL
{
	// This is a single hue entry.
	// Gamma range is oposite that of normal light level. go figure.
	COLOR_TYPE m_GammaRange[LIGHT_QTY];	// Range this hue from Dark=0 to light=31
	WORD m_TableStart;
	WORD m_TableEnd;
	char m_Name[20];
} PACK_NEEDED;
...
{
	DWORD m_Header;
	CUOHueEntry m_Entries[UOHUE_BLOCK_QTY];
} PACK_NEEDED;
