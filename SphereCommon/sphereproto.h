...
extern int CvtSystemToNUNICODE( NCHAR * pOut, int iSizeOutChars, LPCTSTR pInp );
...
public:
	...
	{
		// Use 'ENU' as default if none supplied.
		if ( ! IsDef())
		{
			strcpy( pszLang, "enu" );
		}
...
enum XCMD_TYPE	// XCMD_* messages are unique in both directions.
{
	...
	XCMD_ObjectDropped,				// Seen this sent by the server ?! len=1
	XCMD_UnkBlood,
	XCMD_GodModeOK,
	XCMD_DeathMenu		= 0x2c,
	XCMD_Stats			= 0x2d,
	...
	XCMD_UnkVersions,
	XCMD_EditUpdateObj,
	XCMD_EditUpdateTerrain,
	XCMD_EditUpdateTiledata,
	XCMD_EditUpdateArt,
	XCMD_EditUpdateAnim,
	XCMD_EditUpdateHues,
	XCMD_UnkVersionOK,
	...
	XCMD_EditNewHues,
	XCMD_UnkDestroyArt,
	XCMD_UnkCheckVersion,
	XCMD_ScriptsNames,
	XCMD_ScriptsFile,
	XCMD_LightPoint		= 0x4e,
	XCMD_Light			= 0x4f,
	XCMD_UnkBBHeader,	// 0x50
	XCMD_UnkBBMessage, //
	XCMD_UnkPostMsg,		// 0x52,
	XCMD_ClientState	= 0x53,
	XCMD_Sound			= 0x54,
	XCMD_ReDrawAll		= 0x55,
	XCMD_MapEdit		= 0x56,
	XCMD_UnkRegionsUpdate,
	XCMD_UnkRegionsNew,
	XCMD_UnkEffectNew,
	XCMD_EffectUpdate,
	XCMD_Time			= 0x5b,
	XCMD_UnkVersionRestart,
	XCMD_CharPlay		= 0x5d,
	XCMD_UnkServerList,
	XCMD_UnkServerAdd,
	XCMD_UnkServerDel,	// 0x60
	XCMD_UnkStaticDel,
	XCMD_UnkStaticMove,
	XCMD_UnkLoadArea,
	XCMD_UnkLoadAreaTry,
	...
	XCMD_UnkSimped,
	XCMD_UnkAddLSScript,
	XCMD_Options		= 0x69,	// Friends ?
	XCMD_UnkFriendNotify,
	XCMD_UnkUseKey,
	XCMD_Target			= 0x6c,
	XCMD_PlayMusic		= 0x6d,
	...
	XCMD_Char			= 0x78,
	XCMD_UnkResourceGet,
	XCMD_UnkResourceData,
	XCMD_UnkSequence	= 0x7b,
	XCMD_MenuItems		= 0x7c,
	...
	XCMD_UnkPasswordChange,
	XCMD_DeleteBad		= 0x85,
	XCMD_CharList2		= 0x86,
	XCMD_UnkResourceSend,
	XCMD_PaperDoll		= 0x88,
	XCMD_CorpEquip		= 0x89,
	XCMD_EditTrigger,
	...
	XCMD_FeatureEnable	= 0xb9,
	XCMD_Arrow			= 0xba,
	XCMD_MailMsg		= 0xbb,
	XCMD_Season			= 0xbc,
	XCMD_ClientVersion	= 0xbd,
	XCMD_UnkVersionAssist,
	XCMD_ExtData		= 0xbf,
	XCMD_UnkHuedEffect,
	XCMD_SpeakTable		= 0xc1,
	XCMD_UnkSpeakTableU	= 0xc2,
	XCMD_UnkGQEffect,
	XCMD_UnkSemiVisible,
	XCMD_UnkInvalidMap,
	XCMD_UnkEnableInvalidMap,
	XCMD_ParticleEffect = 0xC7,
	XCMD_UnkUpdateRange,
	XCMD_UnkTripTime,
	XCMD_UnkUTripTime,
	XCMD_UnkGQCount,
	XCMD_UnkTextIDandStr,
	XCMD_Unk_CD,
	XCMD_Unk_CE,
	XCMD_Unk_CF,
	XCMD_Unk_D0,
...
enum EXTDATA_TYPE	// XCMD_ExtData
{
	...
	EXTDATA_Map_Plane		= 0x08, // send to the client
	...
	EXTDATA_Unk13,
	EXTDATA_Anim			= 0x0e, // Yawn and other animations
	EXTDATA_UnkFromCli15,		// from client,. w/ 5 data bytes
	EXTDATA_Unk16,
	EXTDATA_Unk17,
	EXTDATA_Unk18,
	EXTDATA_ContextMenuReq	= 0x13, // (from client) Single click context menu request. (from client) DWORD UID
	EXTDATA_ContextMenu		= 0x14,	// Pop the context menu up on the client.
	EXTDATA_ContextMenuSel	= 0x15,
	EXTDATA_Unk22,
	EXTDATA_Unk23,
	EXTDATA_Unk24,	// 0x18 (from serv) = sent at start up. len=33, 7*DWORD
	EXTDATA_QTY,
};
...
union CUOExtData
{
	...
	struct // 8 = EXTDATA_Map_Plane
	{
		BYTE m_mapplane;	// 1 = map0.mul, 2=map2.mul
	} Map_Plane;
	...
	struct // EXTDATA_Anim
	{
		NDWORD m_Anim;	// ANIM_TYPE
	} Anim;

	struct // EXTDATA_ContextMenu
	{
		NWORD m_one;	// 00 01
		NDWORD m_uid;	// context uid
		BYTE m_qty;	// qty of menu items + 1

		struct
		{
			NWORD m_entryID;	// 0a 17 or 00 6f 
			NWORD m_stringID;	// eb 00 or 17 d8
			NWORD m_flags;	// 0=active, 1=disabled, 0x20 = extra data.
			// NWORD m_extradata; // seems to always be -1
		} m_items[1];
...
enum SCROLL_TYPE	// Client messages for scrolls types.
{
	...
	SCROLL_TYPE_NOTICE = 1,		// ?does not seem to work?
...
enum GUMPCTL_TYPE	// controls we can put in a gump.
{
	...
	GUMPCTL_XMFHTMLGUMP,	// 7 = x,y,sx,sy, 1003000 1 1
	...
	GUMPCTL_TEXTENTRY,		// 7 = x,y,widthpix,widthchars,hue,id,startstringindex
	...
	GUMPCTL_GUMPPICTILED,
	GUMPCTL_CHECKERTRANS,
	GUMPCTL_XMFHTMLGUMPCOLOR,
	GUMPCTL_TILEPICHUE,

	GUMPCTL_AREA,		// x,y,sizex,sizey,id = pressable area.(SphereClient internal Only)
	GUMPCTL_GUMPICON,	// X,Y,GUMP,id (Sphere Only) (this will be the floating "spell icon"
	GUMPCTL_TILEICON,	// X,Y,GUMP,id (Sphere Only) (this will be the floating "spell icon"

	GUMPCTL_QTY,
};

struct CUOEventCharDef
{
...
struct CUOEvent	// event buffer from client to server..
{
// Evidently they made this bigger again, not sure by how much yet though
//#define UO_MAX_EVENT_BUFFER		0x3C00	// Buffer Size (For socket operations)
#define UO_MAX_EVENT_BUFFER		0x7C00	// Buffer Size (For socket operations)
#define UO_MAX_ITEMS_CONT		256		// Max items in a container. (arbitrary)
#define UO_MAX_MENU_ITEMS		64		// number of items in a menu. (arbitrary)
#define UO_MAX_CHARS_PER_ACCT	5

	// Some messages are bydirectional.

	union
	{
		BYTE m_Raw[ UO_MAX_EVENT_BUFFER ];
...
#define MAX_BOOK_LINES 8	// max lines per page.
		...
		struct	// sizeof = 149 // not sure what this is for.
		{
			...
			NWORD m_ProcessorClock;		// @1 = 01 8E
			BYTE  m_nProcessors;		// @3 = 01
			NWORD m_wDirectory[0x10];	// @4 = 00 00
			BYTE m_szVideoCardDescrip2[0x20]; // @24 = AA 7E 3F 04 00
			BYTE m_szModemManufacturer[0x10];	// @44 = 40 F8
			BYTE m_Unk54[0x30];
			BYTE m_bUnk84;				// @84 = 0
			NWORD m_totalRAMinMB;		// @85 = ff 1e
			NWORD m_largestPartitionInMB; // @87 = 2e 00
			NWORD m_Unk8a;					// @89 = 00 01
			NDWORD m_timeZoneBias;		// @8b = 2c 77 f8 37
			BYTE m_bUnk8f;				// @8f = 6a
			NDWORD m_dwUnk90;			// @90 = 20 00 00 00
		...
		struct	// size = ??
		{
			...
			char m_text[1024];	// null terminated version CCryptBase compatible.
		} ClientVersion;
...
struct CUOCommandServer	// command buffer from server to client.
{
#define UO_MAX_SERVER_NAME_SIZE MAX_NAME_SIZE
	// size=40
	NWORD m_count;	// 0=0 based enum. (used to be 1 based?)
	char m_servname[UO_MAX_SERVER_NAME_SIZE];	// 2
...
struct CUOCommand	// command buffer from server to client.
{
	union
	{
		BYTE m_Raw[ UO_MAX_EVENT_BUFFER ];
...
#define ITEMF_INVIS		0x80
		...
		struct // size = 37	// start up player
		{
			...
			NDWORD	m_unk_19;		// 19-20 = 0
			NWORD	m_zero_23;		// 23-24 = 0
			NWORD	m_unk_25;		// 25-26 = 0 = 05 00
			NWORD	m_mode;			// 27-28 = CHARMODE_WAR = 0x0a80
			NWORD	m_unk_29;		// 29-30 = 0960 = 0x02 f0
			NWORD	m_zero_31;
			NDWORD	m_zero_33;
		} Start;
...
#define CHARMODE_INVIS		0x80
		...
		struct // size = 17 = get basic stats
		{
			BYTE m_Cmd;			// 0 = 0x2d
			NDWORD m_UID;		// 1-4 = object UID.
			NWORD m_Str;
		...
		struct // size = var // put up a menu of items.
		{
			BYTE m_Cmd;			// 0=0x7C
			NWORD m_len;
			NDWORD m_UID;		// if player then sphere menu choice bar.
			NWORD m_context;		// = context info passed from server
			BYTE m_lenname;
		...
		struct // size = var // Switch to this player? (in game)
		{
			...
			BYTE m_count;
			BYTE m_unk;	// ? not sure.
			CUOEventCharDef m_char[UO_MAX_CHARS_PER_ACCT];
		} CharList3;
		...
		{
#define MAX_ITEMS_MULTI (UO_MAX_EVENT_BUFFER - 11) / 12// 1279
			BYTE m_Cmd; // 0 = 0x92
		...
		struct // size = 6+servers*40
		{
			BYTE m_Cmd;			// 0 = 0xA8
			NWORD m_len;		// 1-2
			BYTE m_VerCode;		// 3= 0x14 or 0xff, or 0x3d?
			NWORD m_count;	// 4-5=num servers.

#define UO_MAX_SERVERS 32

			CUOCommandServer m_serv[ UO_MAX_SERVERS ];	// size=40
		...
		struct // size = 13 + var // Send a gump text entry dialog.
		{
			...
			char m_text1[1];	// line 1 variable text length
		...
		struct
		{
#define MAX_ITEMS_PREVIEW (UO_MAX_EVENT_BUFFER - 16) / 10
		...
		{
			BYTE m_Cmd;		// 0 = 0xb9
			NWORD m_enable;	// 1 = 3 = 1=chat | 2=LBR
		} FeatureEnable;
		...
		struct // size = 41 // Particle effect. - similar to XCMD_Effect
		{
			// This should work for either 2d or 3d.
			BYTE m_Cmd;			// 0 = 0xc7
			BYTE m_motion;		// 1= the motion type. (0=point to point,3=static) EFFECT_TYPE
			NDWORD m_UID;		// 2-5 = The target item. or source item if point to point.
			NDWORD m_uidTarg;	// 6-9 = 0
			NWORD m_id;			// 10-11 = base display item 0x36d4 = fireball
			NWORD m_srcx;		// 12
			NWORD m_srcy;		// 14
			BYTE  m_srcz;		// 16
			...
			BYTE  m_unknown28[8];
			NWORD m_wParticleID;  // particle effect ID (for 3D client)
			BYTE  m_unknown31[4];
			NDWORD m_uidChar;
			BYTE  m_unknown39[3];
