...
EXPECTED: dict[str, Expectation] = {
    ...
    "I|nested_escape_after_nested": "left 22 right",
    "C|strlen_dot": "3",
    "I|strlen_dot": "3",
    "C|strcmp_dot": "0",
    "C|strindexof_dot": "4",
    ...
    "C|tag_current_property_add": "11",
    "C|tag_current_add": "14",
    "C|tag_current_sub": "12",
    "C|tag_current_expression_add": "14",
    "C|tag_current_absolute": "42",
    "C|tag_current_string": "seed",
    "C|tag_script_hash_literal": "#0DE97",
    ...
    "C|cond_literal_zero": "0",
    "C|cond_literal_hex": "1",
    "C|cond_defname_bare": "1",
    "C|cond_item_id": "1",
    "C|cond_type_id": "1",
