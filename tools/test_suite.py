...
def test_script_function_tables(host, port, game_port, result):
    ...
    try:
        ...
        arg_local_expectations = (
            ...
            ("SPHERE_ARG_COMMA_COMMAND ", "SPHERE_ARG_COMMA_COMMAND first,second,third", "ARG command preserves commas in its value"),
            ("SPHERE_ARG_COMMA_EXPRESSION ", "SPHERE_ARG_COMMA_EXPRESSION alpha,beta,gamma|alpha,beta,gamma", "ARG expression setter preserves commas in its value"),
